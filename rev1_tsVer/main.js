...
const table = document.getElementById("calendar"); //無理やりHTMLTableElement型にしてしまったがこれでよいものか？
...
function update() {
    ...
    // 非表示状態で要素を更新する
    for (let days = 1, i = 1, j = firstDayOfTheMonth /*,daysText: string = String(days) 全部１になってしまった*/; days <= numberOfDays; days++) {
